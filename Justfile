...
doctor:
    @echo "Running diagnostics for blocky-writer..."
...
help-me:
    @echo "=== blocky-writer Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/blocky-writer/issues/new"
    @echo ""
